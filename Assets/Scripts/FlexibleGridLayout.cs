...
// https://www.youtube.com/watch?v=CGsEJToeXmA&list=PLPLsh0LxcxbdA54kChAdBKXfvZcFOdZw8&index=24&ab_channel=GameDevGuide
...
public class FlexibleGridLayout : LayoutGroup
{
    ...
    public override void CalculateLayoutInputHorizontal() //Defualt method call for grid layout
    {
        ...
        if ((fitType == FitType.Height) || (fitType == FitType.Width) || (fitType == FitType.Uniform)){
            ...
            float srtRt = Mathf.Sqrt(transform.childCount);
            rows = Mathf.CeilToInt(srtRt);
            columns = Mathf.CeilToInt(srtRt);
